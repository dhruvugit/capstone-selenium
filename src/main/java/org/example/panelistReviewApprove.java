...
public class panelistReviewApprove {
...
//
//
//        WebElement approveButton2 = driver.findElement(By.xpath("//button[contains(text(),'Approve')]"));
////        WebElement approveButton2 = driver.findElement(By.xpath("//button[@class='btn btn-success' and text()='Approve']"));
//        approveButton2.click();
//        Thread.sleep(3000); // Wait for 3 seconds



        WebElement firstApproveButton = driver.findElement(By.xpath("//button[@data-bs-target='#approve']"));
        ...
        WebElement approveButtonInModal = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@data-bs-dismiss='modal' and text()='Approve']")));
